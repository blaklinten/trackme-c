...
void test_trackme_get_name_not_started(void **);
void test_trackme_get_name_started_not_set(void **);
void test_trackme_get_name_started_set(void **);
void test_trackme_get_name_stopped(void **);
